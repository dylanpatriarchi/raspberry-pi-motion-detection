...
class PerformanceLogger:
    ...
    def log_detection_stats(self, contours_found: int, motion_detected: bool) -> None:
        ...
        self.logger.debug(
            f"Detection stats - Contours: {contours_found}, Motion: {motion_detected}"
        )
...
class MotionDetectionLogger:
    ...
    def log_motion_detected(self, area: float, contours: int) -> None:
        ...
        self.logger.info(
            f"Motion detected #{self.detection_count} - Area: {area:.0f}, Contours: {contours}"
        )
    ...
    def get_statistics(self) -> dict:
        ...
        return {"total_detections": self.detection_count, "total_photos": self.photo_count}
